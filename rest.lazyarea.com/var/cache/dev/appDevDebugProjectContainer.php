...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'weather', 'user' => 'lazyarea', 'password' => 'k4zuhisa', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_755a332f8863db25d9e2008a4a2ca38f99269a16774160d2521667cf7069deda');
    ...
    /**
     * Gets the 'monolog.handler.applog' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['monolog.handler.applog'] = new \Monolog\Handler\StreamHandler('/tmp/mono.log', 400, true, NULL);
    }
    ...
    {
        return $this->services['monolog.handler.file'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/dev.log'), 100, true, NULL);
    }
    ...
    {
        return $this->services['monolog.handler.syslog'] = new \Monolog\Handler\SyslogHandler(false, 'user', 400, true, 1);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9e6bee2083aa2b60eabdef1836ef75d3232ebd76');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('572b78b16f0454.73959515')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'lazyarea',
            'database_password' => 'k4zuhisa',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '9e6bee2083aa2b60eabdef1836ef75d3232ebd76',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '9e6bee2083aa2b60eabdef1836ef75d3232ebd76',
